...
public class LocalChallengeAdapter extends ArrayAdapter<Challenge> {
	
	Context context; 
    int layoutResourceId;    
    Challenge [] challenges = null;

	public LocalChallengeAdapter(Context context, int textViewResourceId, Challenge [] challenges) {
