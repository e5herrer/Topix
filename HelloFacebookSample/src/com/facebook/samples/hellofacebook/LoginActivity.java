...
public class LoginActivity extends FragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("here1", "1");
        viewPager = (ViewPager) findViewById(R.id.pager_login_activity);
        Log.d("here2", "2");
        // Pass results to ViewPagerAdapter Class
        adapter = new ViewPagerAdapter(LoginActivity.this, rank, country,
                population, flag);
        Log.d("here3", "3");
    ...
    private void onSessionStateChange(Session session, SessionState state, Exception exception) {
        ...
        //HEHEHEHEHEHEHEHEHEHEHEHRERERERERERERERERE
        if (state.isOpened()) {
        	finish();
        }
